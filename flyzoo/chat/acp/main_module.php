...
class main_module
{
    ...
    public function main($id, $mode)
    {
        ...
        if ($request->is_set_post('submit'))
        {
			...
			$config->set('FLYZOO_CHAT_ENABLEBPRESS', $request->variable('FlyzooEnableBuddyPress', false));
			$config->set('FLYZOO_CHAT_HIDEINADMIN', $request->variable('FlyzooHideInDashboard', false));
        ...
        $template->assign_vars(array(
			...
			'FLYZOO_CHAT_ENABLEBPRESS' => $config['FLYZOO_CHAT_ENABLEBPRESS'],
			'FLYZOO_CHAT_HIDEINADMIN' => $config['FLYZOO_CHAT_HIDEINADMIN'],
